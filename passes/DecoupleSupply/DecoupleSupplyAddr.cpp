...
namespace {
  ...
  //#include "../../utils/DECLib/DECADES_decoupled.h"
  ...
  void populate_functions(Module &M) {
    ...
    dec_atomic_fetch_add_float = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add_float",
    ...
    dec_atomic_fetch_add_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add_float_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
  ...
  void instrument_compute(Module &M, Function &f) {
	...
	//Instruction *I;
	  ...
	  errs() << "[Created dec_fetch_add conversion]\n";
